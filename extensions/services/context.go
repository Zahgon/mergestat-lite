...
func (ctx Context) GetInt(key string) (int, bool) { _ = "STUB: not implemented"; return 0, false }
...
func (ctx Context) GetBool(key string) (bool, bool) { _ = "STUB: not implemented"; return false, false }
